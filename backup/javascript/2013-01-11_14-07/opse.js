...
*/
	...
	this.setupAdVariables = function()
	{
		if( !window.Fusion.adServer )
		{
			...
			this.admetaSpaceMap["ad_box_2"] = {width: 250, height: 360, rank: 1};
			this.admetaSpaceMap["ad_box_3"] = {width: 250, height: 360, rank: 1};
			this.admetaSpaceMap["ad_box_4"] = {width: 250, height: 360, rank: 1};
...
if( !mm_currentSite )
{
	mm_currentSite = new mm_siteObject({
			...
			'servicefinderId' : 10,
			'flygresorXml': 'http://op.se/polopoly_fs/1.4782205!/flygresor.xml',
			'charterXml' : 'http://op.se/polopoly_fs/1.4730479!/charter.xml'
			});
}
;
